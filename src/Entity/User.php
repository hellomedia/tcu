...
class User implements UserInterface, PasswordAuthenticatedUserInterface, EquatableInterface, EntityInterface
{
    ...
    public const ROLE_AUTOGENERATED_PASSWORD = 'ROLE_AUTOGENERATED_PASSWORD';
    ...
    /**
     * Invitation envoyée à un compte créé par un admin (Admin\Mailer\InvitationMailer)
     */
    #[ORM\Column(type: Types::DATETIMETZ_IMMUTABLE, nullable: true)]
    ...
    /**
     * Compte créé par un admin (PlayerAccountManager) dont la personne n'a pas encore choisi le mot de passe.
     * Le rôle est retiré quand elle en choisit un (ChoosePasswordController, ResetPasswordController).
     */
    public function mustChoosePassword(): bool
    {
        return in_array(self::ROLE_AUTOGENERATED_PASSWORD, $this->roles, true);
    }
